...
export const transformations = [
  ...
  },
  {
    ...
    name: 'Membru Nou',
    story: 'O nouă transformare de succes!',
    before: getImage('transformation-before-28'),
    after: getImage('transformation-after-28'),
  },
  {
    id: 29,
    name: 'Membru Nou',
    story: 'O nouă transformare de succes!',
    before: getImage('transformation-before-29'),
    after: getImage('transformation-after-29'),
  },
  {
    id: 30,
    name: 'Membru Nou',
    story: 'O nouă transformare de succes!',
    before: getImage('transformation-before-30'),
    after: getImage('transformation-after-30'),
  },
  {
    id: 31,
    name: 'Membru Nou',
    story: 'O nouă transformare de succes!',
    before: getImage('transformation-before-31'),
    after: getImage('transformation-after-31'),
  },
  {
    id: 32,
    name: 'Membru Nou',
    story: 'O nouă transformare de succes!',
    before: getImage('transformation-before-32'),
    after: getImage('transformation-after-32'),
  },
  {
    id: 33,
    name: 'Membru Nou',
