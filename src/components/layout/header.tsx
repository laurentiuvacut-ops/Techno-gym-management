...
export default function Header() {
  ...
  return (
    <header className={cn(
        "fixed top-0 left-0 right-0 z-50 flex h-[64px] items-center justify-between w-full py-3 px-4 bg-background/80 backdrop-blur-md border-b border-border/50 transition-all duration-300"
    )}>
