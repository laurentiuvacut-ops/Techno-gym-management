        ...
        >
            ...
            <div className="grid grid-cols-2 gap-4">
                <button onClick={() => setActiveTab('home')}>
                    <div className="w-full glass p-4 rounded-[2rem] flex flex-col items-center justify-center gap-3 h-28 transition-all duration-200 hover:border-primary/40 active:scale-[0.96] group shadow-lg">
