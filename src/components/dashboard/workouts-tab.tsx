    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="space-y-4">
        <div className="space-y-1">
          <h1 className="text-3xl md:text-4xl font-headline tracking-wider flex items-center gap-3">
            <Dumbbell className="w-7 h-7 md:w-8 md:h-8 text-primary shrink-0" />
            Jurnal Antrenament
          </h1>
          <p className="text-sm text-muted-foreground">Evoluează împreună cu comunitatea.</p>
        </div>
        <div className="flex gap-2">
           <Button
            ...
            size="sm"
            className={cn("rounded-xl font-bold uppercase tracking-wider text-xs", activeSubTab === 'my-logs' && "bg-gradient-primary text-primary-foreground")}
          >
            Jurnalul Meu
          </Button>
          <Button
            ...
            size="sm"
            className={cn("rounded-xl font-bold uppercase tracking-wider text-xs", activeSubTab === 'community' && "bg-gradient-primary text-primary-foreground")}
          >
            <Users className="w-4 h-4 mr-1" /> Comunitate
          </Button>
        </div>
      </div>
